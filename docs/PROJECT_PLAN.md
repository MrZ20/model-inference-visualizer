...
> 状态：P0–P4.2 已完成；P5 架构与融合视觉方向已确认，等待视觉稿验收
> 日期：2026-07-09
...
采用长页面 scrollytelling 与全宽 sticky 主画布。视觉语言参考 Transformer Explainer 的“矩阵块 + 连续流程线 + 点击展开 + 教科书解释”，但不复制其 GPT-2 结构或页面布局。页面不是 1440×1024 的单屏仪表盘，也不是静态图片轮播。
