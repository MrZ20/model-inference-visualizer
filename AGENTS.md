...
4. View `docs/assets/p5-fused-long-scroll-direction.png` before frontend visual work.
...
- The selected visual target is `docs/assets/p5-fused-long-scroll-direction.png`.
